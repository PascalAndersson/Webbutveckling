...
namespace Guldrullen.Models.Entities
{
    public partial class GuldrullenContext : DbContext
    {
        ...
        public MovieDisplayVM[] ListMovies(string title, string genre)
        {
            ...
            if (genre == "Action" || genre == "Comedy" || genre == "Romance")
            {
                var movieList = Movie.Where(m => m.Genre == genre && m.Title.Contains(title))
            ...
            else if (genre == "ActionDrama")
            {
                var movieList = Movie.Where(m => m.Title.Contains(title) || (m.Genre == "Action" || m.Genre == "Drama"))
                .Select(m => new MovieDisplayVM
                {
                    Title = m.Title,
                    Id = m.Id,
            ...
            else if (genre == "ComedyDrama")
            {
                var movieList = Movie.Where(m => m.Title.Contains(title) || (m.Genre == "Comedy" || m.Genre == "Drama"))
                .Select(m => new MovieDisplayVM
                {
                    Title = m.Title,
                    Id = m.Id,
            ...
            else if (genre == "ActionComedyDrama")
            {
                var movieList = Movie.Where(m => m.Genre == "Action" || m.Genre == "Comedy" || m.Genre == "Drama")
                .Select(m => new MovieDisplayVM
                {
                    Title = m.Title,
                    Id = m.Id,
